...
Dotfiles managed by [[https://www.chezmoi.io/][chezmoi]] and [[https://github.com/casey/just][just]]. Cross-platform (macOS / Linux /
Windows).
...
nvim ~/.zshrc
just apply      # notices ~/.zshrc was modified,
                # merges changes back to source, then applies
#+end_src
